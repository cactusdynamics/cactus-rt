...
using RealtimeWritableData = cactus_rt::experimental::lockless::spsc::RealtimeWritableValue<Data>;
...
TEST(RealtimeWritableValueTest, ReadAndWrite) {
  RealtimeWritableData data;
